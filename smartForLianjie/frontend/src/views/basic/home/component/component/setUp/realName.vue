    ...
    <div class="set_content">
        <div class="wd_change">
            ...
            <div class="change_pic">
                ...
                <div class="p_pic" v-if="(form.zm != '') || (form.fm != '')">
                    <img :src="ossurl+form.zm + '?x-oss-process=image/resize,p_20'" alt="" class="mainpic" />
                    <img :src="ossurl+form.fm + '?x-oss-process=image/resize,p_20'" alt="" class="mainpic" />
                    <!-- <img v-if="form.souhttp != ''" :src="ossurl+form.souhttp" alt="" class="mainpic" />
                    <img v-else src="@/assets/image/w_yhk.png" class="mainpic"/> -->
                </div>
                <div class="p_pic" v-else>
                    <span>暂无影像</span>
                </div>
...
<script>
import {
  getSFZMessage } from '@/api/basic/index'
...
export default {
  ...
  methods: {
    getData () {
      getSFZMessage({ empno: this.empno }).then(res => {
