(function(e) {
    ...
    var YTX_CONFIG = {
        ...
        _onResponse: function(obj) {
            ...
            if (type == YTX_CONFIG._prototype._callRoute) {
                ...
                if ( !! YTX_CONFIG._voipCallData._callEventCallId) {
                    ...
                    RL_YTX.releaseCall(releaseCallBuilder,
                    function(sucObj) {},
                    function(errObj) {})
                }
                YTX_CONFIG._logout();
            ...
            if (type == YTX_CONFIG._prototype._login) {
                ...
                if ( !! YTX_CONFIG.chatRommId) {
                    ...
                    RL_YTX.enterChatroom(enterChatroomBuilder,
                    function(e) {
            ...
            if (callEventData.getCallEvent() == 1) {
                if (!YTX_CONFIG._voipCallData._callEventCallId) {
                    ...
                    if (resp.code == 200) {
                        ...
                        str = YTX_CONFIG._protobuf._buildCallEvent(callEventData,
                        function() {},
                        function() {})
                    } else {
                    ...
                    callEventData.setStrSDP();
                    var str = YTX_CONFIG._protobuf._buildCallEvent(callEventData,
                    function() {},
                    function() {});
                    YTX_CONFIG._sendMsg(str)
                }
        ...
        _onResponseErr: function(obj) {
            ...
            if (obj["6"] == 580005) {
                if (!request.repeat || request.repeat < 3) {
                    ...
                    var sendStr = YTX_CONFIG._protobuf._buildSyncMessage(YTX_CONFIG._msgVersion + 1, request.endVersion, request.type,
                    function() {},
                    request.repeat);
                    if ( !! sendStr) {
                        YTX_CONFIG._sendMsg(sendStr)
        ...
        _protobuf: {
            _buildLogout: function(callback, onError) {
                ...
                return '{\"MsgLite\":{\"1\":' + YTX_CONFIG._prototype._logout + ',\"2\":' + logOutStr + ',\"3\":' + (YTX_CONFIG._generateClientNo(callback,
                function() {})) + '}}'
            },
        ...
        _onShortAuthFail: function(callback) {
            ...
            YTX_CONFIG._isReconnect = true;
            if (YTX_CONFIG._userPwd) {
                YTX_CONFIG._initScoket(3, callback,
                function() {})
            } else {
                YTX_CONFIG._initScoket(1, callback,
                function() {})
            }
        },
        _reconnect: function(callback) {
            ...
            YTX_CONFIG._isReconnect = true;
            YTX_CONFIG._initScoket(2, callback,
            function() {},
            null, null, true)
        },
        _sendFile: function(fileInfo, content, receiver, msgType, msgId, msgDomain, type, callback, onError, progress, fileName, orignMsgId) {
            ...
            function sendFileByStep() {
                ...
                k = 0;
                if (start < total) {
                    sendStr = YTX_CONFIG._protobuf._buildSendSchedule(function() {},
                    function() {},
                    456);
                    ws.send(sendStr);
        ...
        _setTelRemote: function(callEventData) {
            ...
            YTX_CONFIG.setRemoteDesc(receiverSdp, "answer",
            function() {},
            function(err) {
        ...
        processCreateOffer: function(callback, onerror) {
            try {
                YTX_CONFIG._voipCallData._peerConnection.createOffer().then(callback).
                catch(onerror)
            } catch(e) {
        ...
        processCreateAnswer: function(constraints, callback, onerror) {
            try {
                YTX_CONFIG._voipCallData._peerConnection.createAnswer(constraints).then(callback).
                catch(onerror)
            } catch(e) {
        ...
        _sendVoip: function(CallEventBuilder, callback, onError) {
            ...
            function setLocalDescription(desc, callback, onerror) {
                var pm = pc.setLocalDescription(desc, callback,
                function(err) {
                    onerror({
            ...
            function sendOfferAndAnswer(stream) {
                ...
                if (isCaller) {
                    YTX_CONFIG.processCreateOffer(sendOfferFn, error)
                } else {
                    YTX_CONFIG.setRemoteDesc(YTX_CONFIG._voipCallData._inviteSdp, "offer",
                    function() {
                        var constraints = {
                            mandatory: {
                ...
                function sendOfferFn(desc) {
                    setLocalDescription(desc, sendOffer, onError);
                    var count = 0;
                    function sendOffer() {
                        count++;
                ...
                function sendAnswerFn(desc) {
                    ...
                    setLocalDescription(desc, sendAnswer, onError)
                }
            }
            ...
            YTX_CONFIG._getUserMedia(isVideo, sendOfferAndAnswer,
            function(err) {
                pc.close();
                var resp = {};
        ...
        _getUserMedia: function(isVideo, callback, onerror, needAudio) {
            needAudio = (needAudio == undefined) ? true: false;
        ...
        util: {
            ...
            getBrowerPrefix: function() {
                return 'hidden' in document ? null: function() {
                    var r = null; ['webkit', 'moz', 'ms', 'o'].forEach(function(prefix) {
    ...
    window.RL_YTX = window.RL_YTX || {
        ...
        msgRead: function(MsgReadBuilder, callback, onerror) {
            ...
            RL_YTX.msgOperation(msgOperationBuilder,
            function(e) {
                callback(e)
            },
            function(e) {
        ...
        releaseCall: function(ReleaseCallBuilder, callback, onError) {
            ...
            if (ReleaseCallBuilder.getCaller() == YTX_CONFIG._userName && !YTX_CONFIG._voipCallData._connected) {
                ...
                RL_YTX.rejectCall(rejectCallBuilder,
                function(sucObj) {},
                function(errObj) {})
            }
        ...
        audio: {
            apply: function(obj, onCanPlay, onError) {
                ...
                YTX_CONFIG._getUserMedia(false,
                function(stream) {
